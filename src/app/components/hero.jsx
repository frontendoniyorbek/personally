...
const Hero = () => {
	...
	return (
		<div className=' pt-[18px] hero'>
			<div className='relative flex justify-between hero__container items-center '>
				<div className=' lg:max-w-[464px] sm:mb-0 mb-24 max-w-[400px] w-full mr-5'>
					...
					<p className='hero__text text-[17px] leading-[1.5] mb-[30px]'>{t('hero-info')}</p>
				...
				<div className='relative z-50 hero__img-wrapper'>
