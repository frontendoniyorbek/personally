	...
	return (
		<header className='md:py-[18px] py-[28px]'>
			<div className=' flex items-center container header__container'>
				<h2 className='hover:opacity-80 active:opacity-60 cursor-pointer md:mr-[60px] sm:mr-[30px] mr-7 header__title'>
				...
				<ul className='ml-1 flex items-center mr-auto header__list'>
					...
					<li>
						<a className='hover:text-red-600 cursor-pointer transition duration-150 ease-out hover:ease-in header__link whitespace-nowrap'>
							{t('headerSocil')}
						</a>
					</li>
				</ul>
